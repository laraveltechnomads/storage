...
class CreateAgenciesSpecializationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('agencies_specializations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('agencies_specializations');
    }
}
