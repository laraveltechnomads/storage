...
class CreateReasonOfRefundMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reason_of_refund_masters', function (Blueprint $table) {
            $table->id();
            $table->string('code',16)->collation('utf8_general_ci')->nullable();
            $table->string('description',200)->collation('utf8_general_ci')->nullable();
    ...
    {
        Schema::dropIfExists('reason_of_refund_masters');
    }
}
