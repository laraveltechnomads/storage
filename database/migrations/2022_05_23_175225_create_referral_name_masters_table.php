...
class CreateReferralNameMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('referral_name_masters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('referral_name_masters');
    }
}
