...
class CreateEmrFieldValuesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('emr_field_values', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('used_for')->references('id')->on('adhesions');
    ...
    {
        Schema::dropIfExists('emr_field_values');
    }
}
