...
class CreatePreferredLanguageMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('preferred_language_masters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('preferred_language_masters');
    }
}
