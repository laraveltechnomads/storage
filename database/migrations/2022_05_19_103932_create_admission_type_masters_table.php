...
class CreateAdmissionTypeMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('admission_type_masters', function (Blueprint $table) {
            $table->id();
            $table->string('code',20)->nullable();
            $table->string('description')->collation('utf8_general_ci')->nullable();
            $table->text('link_service')->collation('utf8_general_ci')->nullable();
    ...
    {
        Schema::dropIfExists('admission_type_masters');
    }
}
