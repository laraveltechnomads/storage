...
class CreateItemMarginMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('item_margin_masters', function (Blueprint $table) {
            $table->id();
            $table->string('item_margin_code', 10)->nullable();
    ...
    {
        Schema::dropIfExists('item_margin_masters');
    }
}
