...
class CreateConfigApplicationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('config_applications', function (Blueprint $table) {
            ...
            $table->tinyInteger('apply_concession_to_staff')->comment('1:Yes,0:No')->nullable();
            $table->tinyInteger('allow_clinical_transaction')->comment('1:Yes,0:No')->nullable();
            ...
            $table->tinyInteger('enable_ssl')->comment('1:check,0:Uncheck')->nullable();
            ...
            $table->tinyInteger('is_allow_discharge_request')->comment('1:Yes,0:No')->nullable();
