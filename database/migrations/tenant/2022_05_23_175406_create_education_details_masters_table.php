...
class CreateEducationDetailsMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
    Schema::create('education_details_masters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('education_details_masters');
    }
}
