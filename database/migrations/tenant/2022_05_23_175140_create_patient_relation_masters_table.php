...
class CreatePatientRelationMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('patient_relation_masters', function (Blueprint $table) {
            $table->id();           
    ...
    {
        Schema::dropIfExists('patient_relation_masters');
    }
}
