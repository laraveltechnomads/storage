...
class CreateBedReleaseChecksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bed_release_checks', function (Blueprint $table) {
            $table->id();
            $table->string('code',20)->nullable();
            $table->string('description')->collation('utf8_general_ci')->nullable();
            $table->tinyInteger('is_mandatory')->default(1)->comment('1:Check,0:Uncheck');
    ...
    {
        Schema::dropIfExists('bed_release_checks');
    }
}
