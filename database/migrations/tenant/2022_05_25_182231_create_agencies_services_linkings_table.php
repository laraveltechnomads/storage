...
class CreateAgenciesServicesLinkingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('agencies_services_linkings', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('unit_id')->nullable();

            $table->unsignedBigInteger('agency_id')->nullable();
            $table->unsignedBigInteger('specialization_id')->nullable();
            $table->unsignedBigInteger('sub_specialization_id')->nullable();
            $table->string('linked_services')->nullable();
            ...
            $table->foreign('sub_specialization_id')->references('id')->on('sub_specializations');
        });
    }
    ...
    {
        Schema::dropIfExists('agencies_services_linkings');
    }
}
