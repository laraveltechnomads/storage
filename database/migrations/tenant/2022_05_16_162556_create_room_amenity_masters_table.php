...
class CreateRoomAmenityMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('room_amenity_masters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('room_amenity_masters');
    }
}
