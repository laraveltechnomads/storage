...
class CreateDischargeTemplateMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('discharge_template_masters', function (Blueprint $table) {
            $table->id();
            $table->string('code',20)->nullable();
            $table->string('description')->collation('utf8_general_ci')->nullable();
            $table->longText('template')->collation('utf8_general_ci')->nullable();
    ...
    {
        Schema::dropIfExists('discharge_template_masters');
    }
}
