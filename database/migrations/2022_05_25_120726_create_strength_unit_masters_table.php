...
class CreateStrengthUnitMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('strength_unit_masters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('strength_unit_masters');
    }
}
