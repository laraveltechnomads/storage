...
class CreateAnesthesiaTypeMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('anesthesia_type_masters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('anesthesia_type_masters');
    }
}
