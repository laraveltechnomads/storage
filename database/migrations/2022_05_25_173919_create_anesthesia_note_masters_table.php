...
class CreateAnesthesiaNoteMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('anesthesia_note_masters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('anesthesia_note_masters');
    }
}
