...
class CreateDoctorScheduleMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('doctor_schedule_masters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('doctor_schedule_masters');
    }
}
