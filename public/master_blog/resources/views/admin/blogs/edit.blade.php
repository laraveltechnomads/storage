    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card">
                    <div class="card-body">
                        <form class="forms-sample" id="blogForm" action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="category" id="category">
                                    <option value="Article" {{ $blog->category == 'Article' ? 'selected' : '' }}>Article</option>
                                    <option value="Article" {{ $blog->category == 'Article' ? 'selected' : '' }}>Article</option>
                                    <option value="Article" {{ $blog->category == 'Article' ? 'selected' : '' }}>Article</option>
                                    <option value="Article" {{ $blog->category == 'Article' ? 'selected' : '' }}>Article</option>
                                    <option value="Article" {{ $blog->category == 'Article' ? 'selected' : '' }}>Article</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" rows="2" id="meta_keywords" name="meta_keywords" required="">{{old('meta_keywords', @$blog->meta_keywords)}}</textarea>
                            </div>
                            @php
                                $publish_date =  date('d/m/Y', strtotime(@$blog->publish_date) );
                            @endphp
                            <div class="form-group col-md-6">
                                <label for="publish_date">{{ __('Publish Date')}}  - {{ $publish_date }}</label>
                                <input type="date" class="form-control @error('publish_date') is-invalid @enderror" id="publish_date" name="publish_date" placeholder="" value="{{old('publish_date', $publish_date )}}">
                                @error('publish_date')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <img id="blah" src="{{ blog_public_path().$blog->feature_image}}" height="200px" width="200px" alt="your image"> 
                            </div>
