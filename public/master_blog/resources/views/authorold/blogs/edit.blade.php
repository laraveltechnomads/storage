                    ...
                    <div class="card-body">
                        <form class="forms-sample" id="blogForm" action="{{ route('author.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" placeholder="Title" value="{{old('title', @$blog->title)}}">
                                @error('title')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" rows="2" id="meta_description" name="meta_description">{{old('meta_description', @$blog->meta_description)}}</textarea>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control col-md-12 select2 js-example-basic-single" multiple="multiple" name="tags[]", id="tags">
                                    @forelse($tags as $tag)
                                        <option value="{{$tag->id}}" {{ in_array($tag->id,$blog->tag_id)?'selected':''}}>{{$tag->tag}}</option>
                                    @empty
                                    @endforelse
                                </select>
                            </div>
