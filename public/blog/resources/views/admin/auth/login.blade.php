...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="{{asset('/')}}assets/admin/favicon.png" />
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="#"><img width="100" src="{{ asset('assets/admin/header_logo.png') }}" alt="{{ config('app.name')}}" ></a>
            </div>
            <!-- /.login-logo -->
            <div class="card">
