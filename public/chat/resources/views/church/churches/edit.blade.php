@extends('church.layouts.master') @section('title', 'Edit Church') @push('style')
@endpush 

@section('breadcrumb-title')
<h1>Edit Church</h1>
<a href="{{ route('church.show') }}" tooltip="Blogs List" class="badge badge-primary"><i class="fa fa-arrow-left"></i></a>
    <span>{{ __('Back')}}</span>
@stop 
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="forms-sample" id="blogForm" action="{{ route('church.update', [$church->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <!-- text input -->
