...
{
    /* reg Valid Step One*/
    public function regIndividualValidStepOne($request, $datareq)
    {
    ...
    /* reg Valid Step Two*/
    public function regIndividualValidStepTwo($request)
    {
        $data = Validator::make($request,[
    ...
    public function regIndividualValidStepThree($request)
    {
        $data = Validator::make($request,[
            'registration_number' => 'required|exists:registrations,id',
            'registration_type' => 'required|exists:patient_categories,reg_code',
    ...
    /* reg Valid Step Four*/
    public function regIndividualValidStepFour($request)
    {
        $data = Validator::make($request,[
            'registration_number' => 'required|exists:registrations,id',
            'registration_type' => 'required|exists:patient_categories,reg_code',
    ...
    /* reg steop one Individual details */
